  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Actuator Serial Number', value: 'actuatorSerialNumber', sortable: false },
        { text: 'Control Pack', value: 'controlPack', sortable: false },
        { text: 'Visual', value: 'visual', sortable: false },
        { text: 'Water Inspection', value: 'waterInspection', sortable: false },
        { text: 'Operational Test', align: 'start', value: 'operationalTest' },
